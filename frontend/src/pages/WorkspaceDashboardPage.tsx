...
export const WorkspaceDashboardPage: React.FC = () => {
  ...
  const { currentWorkspace, currentWorkspaceUser, logoutWorkspace } = useAuth();
    ...
    <div className="flex flex-col gap-6 pb-12">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl text-xs font-bold border border-[var(--border-color)] text-[var(--text-secondary)] hover:border-[var(--accent-border)] cursor-pointer shrink-0"
        >
          Leave Workspace
        </button>
      </div>
