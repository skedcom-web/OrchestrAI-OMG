...
export const NAV_DOMAINS: NavDomain[] = [
  ...
  },
  {
    ...
    question: 'Is governance actually working?',
    icon: '🚀',
    accent: '#22C55E',
    modules: [
      {
        path: '/governance-effectiveness',
        label: 'Effectiveness Score',
        icon: '🧮',
        description: 'Is governance improving over time — evidence, review, findings, reassessment, policy and drift trends, compared to the last recorded reading.',
        keywords: ['effectiveness', 'score', 'trend', 'improvement'],
        badge: 'Release 11',
      },
      {
        path: '/governance-roi',
        label: 'Governance ROI',
        icon: '💰',
        description: 'Governance activity translated into business language — operational savings, risk avoidance, estimated value delivered.',
        keywords: ['roi', 'value', 'savings', 'business case'],
        badge: 'Release 11',
      },
      {
        ...
        icon: '📶',
        description: 'Reactive through Optimized, by domain — governance program, evidence, decisions, compliance, accountability, continuous assurance.',
        keywords: ['maturity', 'reactive', 'optimized', 'domain'],
        badge: 'Release 11',
      },
      {
        path: '/governance-benchmarking',
        label: 'Governance Benchmarking',
        icon: '📐',
        description: 'Compare governance effectiveness against industry reference benchmarks — gap analysis and improvement opportunities.',
        keywords: ['benchmark', 'industry', 'comparison', 'gap analysis'],
        badge: 'Release 11',
      },
      {
        path: '/governance-outcomes',
        label: 'Governance Outcomes',
        icon: '🎯',
        description: 'What value did governance deliver — risks prevented, drift resolved, gaps eliminated, not just activity performed.',
        keywords: ['outcomes', 'value delivered', 'risks prevented'],
        badge: 'Release 11',
      },
    ],
  },
  {
    ...
    question: 'Can we trust the score?',
    icon: '🧭',
    accent: '#0EA5E9',
    modules: [
      {
        ...
        icon: '📝',
        description: 'Record a standardized governance assessment — ten categories, one 1-5 scale, every time.',
        keywords: ['assessment', 'score', 'record', 'evaluate'],
        badge: 'GACF',
      },
      {
        path: '/assessment-playbooks',
        label: 'Assessment Playbooks',
        icon: '📖',
        description: 'Structured guidance for each assessment type — objective, scope, criteria, and how to read the score.',
        keywords: ['playbook', 'guidance', 'methodology', 'prompts'],
        badge: 'GACF',
      },
      {
        path: '/calibration-library',
        label: 'Calibration Library',
        icon: '📚',
        description: 'The standardized scoring rubric, and worked examples of it applied to real scenarios.',
        keywords: ['calibration', 'scoring template', 'reference', 'rubric'],
        badge: 'GACF',
      },
      {
        ...
        icon: '📊',
        description: 'Observed dispersion in recorded assessment scores — no acceptable-variance threshold assumed.',
        keywords: ['variance', 'reliability', 'consistency', 'dispersion'],
        badge: 'GACF',
      },
      {
        path: '/assessment-academy',
        label: 'Assessment Academy',
        icon: '🎓',
        description: 'Guidance on assessment concepts, scoring methodology, evidence expectations, and best practices.',
        keywords: ['academy', 'training', 'onboarding', 'best practices'],
        badge: 'GACF',
      },
      {
        path: '/assessor-certification',
        label: 'Assessor Certification',
        icon: '🏅',
        description: 'Score benchmark scenarios from the Calibration Library and see your calibration accuracy.',
        keywords: ['certification', 'calibration accuracy', 'training', 'assessor'],
        badge: 'Release 13 Ext.',
      },
      {
        path: '/consensus-assessments',
        label: 'Multi-Assessor Consensus',
        icon: '👥',
        description: 'Multiple assessors independently score the same asset — hidden until the round closes, then a consensus report.',
        keywords: ['consensus', 'multi-assessor', 'independent scoring', 'variance'],
        badge: 'Release 13 Ext.',
      },
      {
        path: '/benchmark-recommendations',
        label: 'Benchmark Recommendations',
        icon: '🧭',
        description: 'Pick Use Case, Risk Category and Asset Type — get the most relevant playbooks, reference examples and typical scoring ranges.',
        keywords: ['benchmark', 'recommendation', 'guided assessment', 'similar assets'],
        badge: 'Release 13 Ext.',
      },
    ],
  },
  ...
  },
  {
    ...
    modules: [
      ...
      {
        path: '/regulatory-applicability',
        label: 'Regulatory Applicability',
        icon: '🌐',
        description: 'Which regulations apply to this tenant, scoped by the active Governance Profile.',
        keywords: ['applicability', 'which regulations apply', 'scope'],
        badge: 'Release 12',
      },
      {
        path: '/cross-framework-mapping',
        label: 'Cross-Framework Mapping',
        icon: '🔗',
        description: 'What controls satisfy multiple frameworks — evidence already doing double duty across compliance packs and regulatory sources.',
        keywords: ['cross-framework', 'reuse', 'control mapping', 'evidence reuse'],
        badge: 'Release 12',
      },
      {
        path: '/compliance-impact-analysis',
        label: 'Compliance Impact Analysis',
        icon: '🔁',
        description: "What changed recently, and what's the compliance impact — cross-referenced against the affected asset's governance posture.",
        keywords: ['change impact', 'compliance impact', 'what changed'],
        badge: 'Release 12',
      },
      {
        path: '/regulatory-change-readiness',
        label: 'Regulatory Change Readiness',
        icon: '📶',
        description: 'Active regulatory sources ranked by how ready this organization is if that regulation changed tomorrow.',
        keywords: ['change readiness', 'regulatory readiness', 'coverage ranking'],
        badge: 'Release 12',
      },
      {
        path: '/audit-readiness-intelligence',
        label: 'Audit Readiness Intelligence',
        icon: '📄',
        description: 'What evidence supports compliance today — asset-level and framework-level readiness, combined.',
        keywords: ['audit readiness', 'evidence gaps', 'audit intelligence'],
        badge: 'Release 12',
      },
    ],
  },
