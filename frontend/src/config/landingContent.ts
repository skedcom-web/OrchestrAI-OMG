...
export const JOURNEY_STAGES: JourneyStage[] = [
  ...
  },
  {
    ...
    label: 'Ownership',
    icon: '👥',
    summary: 'Assign five named accountable owners.',
    purpose:
      'Attach real, named accountability. Without an owner an issue cannot be escalated and a decision cannot be defended.',
    inputs: ['Candidate owners from the user directory', 'Departmental accountability model'],
    outputs: ['Business, Technical, Risk and Compliance Owners', 'A designated Approver'],
...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    look: 'Readiness is scored out of 100 first; failing pillars appear as blockers that must be cleared.',
  },
  {
    n: 6,
