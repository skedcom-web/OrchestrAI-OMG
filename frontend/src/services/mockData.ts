...
export const DEMO_PERSONAS: PersonaDemoUser[] = [
  {
    ...
    icon: '👑',
    allowedNav: [
      '/', '/dashboard', '/assets', '/models', '/model-lifecycle', '/model-risk', '/model-analytics', '/ownership', '/risk', 
  ...
  },
  {
    ...
    icon: '⚡',
    allowedNav: [
      '/', '/dashboard', '/assets', '/models', '/model-lifecycle', '/model-risk', '/model-analytics', '/risk', '/evidence', '/evidence-registry', '/review-workbench', '/findings',
      '/decision-intelligence', '/governance-blockers', '/decision-workbench-v4', '/decision-dashboard',
  ...
  },
  {
    ...
    icon: '💼',
    allowedNav: [
      '/', '/dashboard', '/assets', '/models', '/model-lifecycle', '/model-risk', '/model-analytics', '/ownership', '/evidence', '/evidence-registry', '/decision-intelligence', 
  ...
  },
  {
    ...
    icon: '🧪',
    allowedNav: [
      '/', '/dashboard', '/assets', '/models', '/model-lifecycle', '/model-risk', '/model-analytics', '/validation', '/evidence', '/evidence-registry', '/review-workbench', '/findings', 
  ...
  },
  {
    ...
    icon: '📜',
    allowedNav: [
      '/', '/dashboard', '/assets', '/models', '/model-lifecycle', '/model-risk', '/model-analytics', '/evidence', '/evidence-registry', '/findings', '/decision-workbench-v4', '/decision-dashboard',
      '/compliance-center', '/compliance-packs', '/regulatory-library', '/compliance-findings', '/compliance-dashboard',
      '/operations-center', '/kill-switch', '/override-center', '/incidents', '/operations-dashboard', '/retirement', '/governance-timeline',
      '/governance-monitoring', '/governance-alerts', '/review-calendar', '/corrective-actions', '/governance-trends', '/audit-logs',
      // Phase 8 — Governance Operating System
  ...
  },
  {
    ...
    icon: '👁️',
    allowedNav: [
      '/', '/dashboard', '/assets', '/models', '/model-lifecycle', '/model-risk', '/model-analytics', '/validation-dashboard', '/decision-dashboard', '/compliance-dashboard', '/operations-dashboard', '/governance-trends',
      // Phase 8 — Governance Operating System
      '/asset-lifecycle', '/command-center',
