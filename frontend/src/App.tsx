...
import { AuthorityProvenanceRegistryPage } from './pages/AuthorityProvenanceRegistryPage';
...
const GOVERNED_ROUTES: { path: string; element: React.ReactNode }[] = [
  ...
  { path: '/control-library', element: <ControlLibraryPage /> },
  { path: '/control-mapping', element: <ControlMappingPage /> },
  { path: '/control-effectiveness', element: <ControlEffectivenessPage /> },
  ...
  { path: '/authority-provenance', element: <AuthorityProvenanceRegistryPage /> },
